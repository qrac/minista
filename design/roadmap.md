...
- source change → affected RouteNode／PageNodeを特定済み。Artifact edgeへの拡張は未実装
- page固有document変更は該当URLだけreloadし、layoutなど全体変更だけ標準full reloadを使用。Artifact由来reloadの細分化は未実装
